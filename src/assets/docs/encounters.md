...
Some monsters also have a final action that triggers when they are killed - a Tinderjack, for instance, detonates. Killing one of these at close range is not always the safest way to deal with it.
