			...
			<div className={className} onClick={this.onClick}>
				...
				<div className='playing-card-inner'>
					<div className={`playing-card-front ${this.props.type.toLowerCase()}`}>
						<div className='card-content'><ErrorBoundary className='card-content'>{this.props.front}</ErrorBoundary></div>
						{
							hasFooter ?
					...
					<div className={`playing-card-back ${this.props.type.toLowerCase()}`}>
						<div className='card-content'><ErrorBoundary className='card-content'>{this.props.back}</ErrorBoundary></div>
						{
							hasFooter ?
								<div className={`card-footer ${footerType}`}>
